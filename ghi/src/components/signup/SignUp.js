    ...
    return (
        <div className="sign-up-container">
            ...
            <form>
                ...
                <InputTag field={field} value={email} name="email" type="email" placeholder="johndoe@email.com" />
                <FormLabel>Password</FormLabel>
                <InputTag field={field} value={password} name="password" type="password" placeholder="********" />
